	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 lerpResult81 = lerp( ( tex2D( _TextureSample2, uv_TextureSample2 ) + float4( 0,0,0,0 ) ) , ( tex2D( _TextureSample4, uv_TextureSample4 ) + tex2D( _TextureSample5, uv_TextureSample5 ) ) , temp_output_92_0);
				...
				float3 Color = lerpResult81.rgb;
				float Alpha = lerpResult97.x;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = lerpResult97.x;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_TextureSample7 = IN.ase_texcoord1.xy * _TextureSample7_ST.xy + _TextureSample7_ST.zw;
				float time85 = 8.84;
				float2 voronoiSmoothId85 = 0;
...
/*ASEBEGIN
Version=19103
Node;AmplifyShaderEditor.SimpleAddOpNode;74;-592.153,8.930772;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;71;-903.4496,1019.139;Inherit;False;Property;_Float0;Float 0;6;0;Create;True;0;0;0;False;0;False;0;0.4124678;0;3;0;1;FLOAT;0
...
WireConnection;152;2;81;0
WireConnection;152;3;97;0
ASEEND*/
//CHKSM=B7734F17C1CBC25E9BA14780389EFF3047C1FAD9